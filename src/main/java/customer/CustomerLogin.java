...
public class CustomerLogin extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        final String PATH = "C:\\Users\\Adib Zaini\\Desktop\\CS230 PART 3\\CSC483\\Project\\New Folder\\project\\src\\main\\java\\database\\customer.txt";
        ...
        try {
            ...
            while(reader.hasNextLine()) {
                ...
                if (!line[1].equals(username)) continue;
                if (!line[2].equals(password)) continue;
                System.out.println(line[0] + " Logged In!");
                isCorrect = true;
                Customer obj = new Customer(line[0], line[3]);
                dispose();
                obj.setVisible(true);
            }
            reader.close();
